...
const { adminRegisteration, updateOrderStatus, listOrders, fetchOrderDetails, getStats, uploadDoc, getContacts, contactUs, login, getNewRequests, getDocsDelivered, getAppointments, scheduleAppointment } = require('./adminController')
...
adminRouter.get('/get_contact_details', getContacts)
